...
<head>
    ...
    <section class="services-section">
            <div class="service">
                <img src="images/wedding-photo 2.jpg" alt="Layanan Fotografi" class="gambar-fotografi">
            </div>

        <div class="service">
            <h2>Fotografi</h2>
            <img src="images/wedding-photo 3.jpg" alt="Layanan Fotografi" class="gambar-fotografi">
            <p>Harga: $300</p>
            <button onclick="addToCart('Fotografi', 300)" class="btn btn-primary btn-block">Tambah ke Keranjang</button>
        </div>
        <div class="service">
            <img src="images/wedding-photo.jpg" alt="Layanan Fotografi" class="gambar-fotografi">
    ...
    <section class="services-section">
        <div class="service">
            ...
            <video controls width="300">
                    <source src="video/wedding-drone.mp4" type="video/mp4">
        ...
        <div class="service">
            ...
            <p>Harga: $350</p>
            <button onclick="addToCart('Videografi', 350)" class="btn btn-primary btn-block">Tambah ke Keranjang</button>
        </div>
    </section>
