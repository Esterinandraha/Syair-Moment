...
<head>
    ...
    <section class="services-section">
        <div class="service">
            <h2>Fotografi</h2>
            <img src="images/editorial 1.jpg" alt="Layanan Fotografi" class="gambar-fotografi">
            <p>Harga: $200</p>
            <button onclick="addToCart('Fotografi', 200)" class="btn btn-primary btn-block">Tambah ke Keranjang</button>
        </div>
        <div class="service">
            <h2>Fotografi</h2>
            <img src="images/editorial.png" alt="Layanan Fotografi" class="gambar-fotografi">
            <p>Harga: $300</p>
    ...
    <section class="services-section">
        <div class="service">
            ...
            <video controls width="300">
                    <source src="video/video-editorial.mp4" type="video/mp4">
        ...
        <div class="service">
            <h2>Videografi</h2>
            <video controls width="300">
                    <source src="video/editorial-drone.mp4" type="video/mp4">
                    Your browser does not support the video tag.
                </video>
            <p>Harga: $350</p>
